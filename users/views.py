...
async def send_otp(request):
    ...
    if request.method == 'POST':
        ...
        user, created = await sync_to_async(User.objects.get_or_create)(phone_number=phone_number)
        ...
        if form.is_valid():
            ...
            try:
                ...
                if current_user.invited_by:
                    ...
                    current_user.invited_by = inviter  # Связываем пользователя с тем, кто его пригласил
                    current_user.save()
